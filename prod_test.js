...
async function runProdTest() {
  ...
  try {
    ...
    const resOrder = await client.query(
      "INSERT INTO pedidos_app_orders (customer_name, customer_phone, crm_contact_id, source, total, delivery_type, payment_method) VALUES ('PROD TEST', '3999999999', , 'MANUAL', 100, 'domicilio', 'efectivo') RETURNING id, crm_contact_id",
      [idBsuid]
    );
