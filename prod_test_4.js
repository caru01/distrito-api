...
async function runProdTest() {
  ...
  try {
    ...
    const queryStr = "INSERT INTO pedidos_app_orders (customer_name, customer_phone, crm_contact_id) VALUES ('PROD TEST', '3999999999', " + idBsuid + ") RETURNING id, crm_contact_id";
